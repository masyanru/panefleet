...
impl View for PaneFleetTaskDialog {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let body = format!(
            "The task names the sidebar row and the tabs of this environment; the branch moves to \
             secondary metadata. A leading tracker key such as SEC-1802 or inc-36884 is recognized \
