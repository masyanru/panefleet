...
pub(super) struct WorkspaceMouseStates {
    ...
    pub(super) panefleet_fleet_overview: MouseStateHandle,
    pub(super) panefleet_fleet_overview_close: MouseStateHandle,
    pub(super) panefleet_fleet_dashboard_close: MouseStateHandle,
...
pub struct WorkspaceState {
    ...
    pub is_panefleet_fleet_overview_open: bool,
    pub is_panefleet_fleet_dashboard_open: bool,
