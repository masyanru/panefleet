...
- **Fleet Dashboard entry** — постоянная строка над workspace в Project
  Sidebar;
- **Fleet Dashboard** — широкая центральная панель для продолжительной работы
  с обзором;
...
- popover и dashboard используют непрозрачный `surface_2`, чтобы терминальный
  текст не просвечивал через панель;
...
- количество workspace с обнаруженными агентами;
- распределение сессий по типам агента;
- анимированные точки в карточке `Working` и строках работающих сессий.
